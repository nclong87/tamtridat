		...
		<div id="top_icon" style="padding-top:0;">
		  <div align="center">
			<div><a href="#"><img src="<?php echo BASE_PATH ?>/public/images/icons/add_icon.png" alt="big_settings" width="25" height="26" border="0" /></a></div>
					<span class="toplinks">
			  <a href="#" onclick="openForm()"><span class="toplinks">THÊM TIN MỚI</span></a></span><br />
		  </div>
		</div>
		<div id="top_icon" style="padding-top:0;">
		  <div align="center">
			<div><a href="#"><img src="<?php echo BASE_PATH ?>/public/images/icons/delete-icon.png" alt="delete-icon" width="26" height="26" border="0" /></a></div>
					<span class="toplinks">
			  <a href="#" onclick="doRemove()"><span class="toplinks">XÓA TIN</span></a></span><br />
		  </div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function openForm(id) {
		window.open(url('/tintuc/form/'+id),'News','resizable=yes,menubar=no,toolbar=no,status=no,width=1000');
	}
	...
	$(document).ready(function(){				
		...
		oTable = $('#dataTable').dataTable({
			...
			"bServerSide": true,
			"bAutoWidth": false,
			"sAjaxSource": url("/tintuc/listTintuc"),
			"aoColumns": [
						{ "mDataProp": "tintuc.id","bSortable": false,"sClass":"alignCenter"},
						{ "mDataProp": "tintuc.title","bSortable": false },
						{ "mDataProp": "tintuc.viewcount","bSortable": false },
						{
							"bSortable": false,
							"fnRender": function( oObj ) {
								tintuc = oObj['aData']['tintuc'];
								return $.format.date(tintuc['datemodified'], 'dd/MM/yyyy HH:ss');
							} 
						},
						{ 	"mDataProp": "tintuc.usermodified","bSortable": false },
						{ 	"bSortable": false,"sClass":"alignCenter",
							"fnRender": function( oObj ) {
								tintuc = oObj['aData']['tintuc'];
								if(tintuc['backuped']==1)
									return "<center><div class='inactive' onclick=\"doActive('"+tintuc['id']+"')\" title='Active tin này'></div></center>";
								else if(tintuc['backuped']==0)
									return "<center><div class='active' onclick=\"doUnActive('"+tintuc['id']+"')\" title='Bỏ Active tin này'></div></center>";
								else
									return 'N/A';
							} 
						},
						{ 	"mDataProp": null,"bSortable": false,
							"fnRender": function( oObj ) {
								return '<center><input type="checkbox" value="'+tintuc['id']+'" onclick="doCheck(this)"/></center>'; 
							}
						},
						{ 	"mDataProp": null,"bSortable": false,
							"fnRender": function( oObj ) {
								return '<center><img src="'+url('/public/images/icons/edit.png')+'" title="Chỉnh sửa" style="cursor:pointer" onclick="openForm(\''+tintuc['id']+'\')"/></center>'; 
							}
						}
					],
